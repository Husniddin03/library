                            ...
                            <div class="custom-block d-flex">
                                <div class="">
                                    <div class="custom-block-icon-wrap">
                                        ...
                                        <a href="detail-page.html" class="custom-block-image-wrap">
                                            <img src="{{ asset('images/podcast/11683425_4790593.jpg') }}" class="custom-block-image img-fluid" alt="">
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <div class="profile-block d-flex">
                                        <img src="{{ asset('images/profile/woman-posing-black-dress-medium-shot.jpg') }}" class="profile-block-image img-fluid" alt="">

                                        <p>
                                            Elsa
                                            <img src="{{ asset('images/verified.png') }}" class="verified-image img-fluid" alt="">
                            ...
                            <div class="custom-block d-flex">
                                <div class="">
                                    <div class="custom-block-icon-wrap">
                                        <div class="section-overlay"></div>
                                        <a href="detail-page.html" class="custom-block-image-wrap">
                                            <img src="{{ asset('images/podcast/12577967_02.jpg') }}" class="custom-block-image img-fluid" alt="">
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <div class="profile-block d-flex">
                                        <img src="{{ asset('images/profile/handsome-asian-man-listening-music-through-headphones.jpg') }}" class="profile-block-image img-fluid" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                            <div class="custom-block custom-block-full">
                                <div class="custom-block-image-wrap">
                                    <a href="detail-page.html">
                                        <img src="{{ asset('images/podcast/27376480_7326766.jpg') }}" class="custom-block-image img-fluid" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                            <div class="custom-block custom-block-full">
                                <div class="custom-block-image-wrap">
                                    <a href="detail-page.html">
                                        <img src="{{ asset('images/podcast/27670664_7369753.jpg') }}" class="custom-block-image img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <div class="profile-block d-flex">
                                        <img src="{{ asset('images/profile/cute-smiling-woman-outdoor-portrait.jpg') }}" class="profile-block-image img-fluid" alt="">
